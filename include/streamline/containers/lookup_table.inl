...
namespace sl::generic {
	...
	// constexpr lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::generic_lookup_table(ContainerT&& contents, HashT&& hash, KeyEqualT&& equal) noexcept 
	// requires 
	...
	// constexpr lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::generic_lookup_table(initializer_list<value_type> il, HashT&& hash, KeyEqualT&& equal) noexcept 
	// requires
...
namespace sl::generic {
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	template<typename K> 
	constexpr auto&& lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::at(this auto&& self, K&& key) noexcept requires compatible_key<K> {
	...
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	template<typename K> 
	constexpr auto lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::try_at(this auto&& self, K&& key) noexcept requires compatible_key<K> {
		//TODO
	}
	
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	template<typename K> 
	constexpr auto&& lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::operator[](this auto&& self, K&& key) noexcept requires compatible_key<K> {
		auto it = self.find(forward<K>(key));
	...
	template<size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	template<auto I>
	constexpr auto&& lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::get(this auto&& self) noexcept requires compatible_key<decltype(I)> {
...
namespace sl::generic {
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	template<typename K> 
	constexpr size_t lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::count(K&& key) const noexcept requires compatible_key<K> {
	...
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	template<typename K> 
	constexpr bool lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::contains(K&& key) const noexcept requires compatible_key<K> {
...
namespace sl::generic {
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	template<typename K> 
	constexpr auto lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::equal_range(this auto&& self, K&& key) noexcept requires compatible_key<K> {
...
namespace sl::generic {
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	consteval size_t
	lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::bucket_count() noexcept {
		return hash_table_type::storage_size;
	}
	
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	consteval size_t
	lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::max_bucket_count() noexcept {
		return hash_table_type::storage_size;
	}
}
...
namespace sl::generic {
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	constexpr auto lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::hash_function(this auto&& self) noexcept {
		return forward_as_lvalue<decltype(self)>(self)._hash;
	}
	
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	constexpr auto lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::key_eq(this auto&& self) noexcept {
...
namespace sl::generic {
	template <size_t N, typename Key, typename Value, typename Hash, typename KeyEqual>
	template <typename K>
	constexpr index_t lookup_table<sl::size_constant_type<N>, Key, Value, Hash, KeyEqual>::lookup(K const& key) const noexcept {
