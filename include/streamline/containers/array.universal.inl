...
namespace sl::generic {
	...
	template<
		traits::specialization_of<generic::array> R,
		typename... Args
	> 
...
namespace sl::generic {
	...
	requires (
		...
		traits::same_container_as<R, generic::array, sl::size_constant_type<tuple_traits<XfrmSeq>::size>, placeholder_t>
	)
	...
	noexcept(traits::is_noexcept_invocable_each_v<XfrmEachFn&&, Arg&&>) {
		return impl::make_array_from_container<::sl::array<XfrmSeq::size(), remove_cvref_t<invoke_each_return_type_t<XfrmEachFn&&, Arg&&>>>>(
	...
	requires (
		...
		traits::same_container_as<R, generic::array, sl::size_constant_type<N>, placeholder_t>
	)
	...
	noexcept(traits::is_noexcept_invocable_v<XfrmEachFn&&, Arg&&, index_constant_type<0>>) {
		return impl::make_array_from_value<::sl::array<XfrmSeq::size(), remove_cvref_t<invoke_return_type_t<XfrmEachFn&&, Arg&&, index_constant_type<0>>>>>(
