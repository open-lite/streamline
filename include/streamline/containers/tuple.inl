...
namespace sl {
	...
	constexpr generic_tuple<_UnusedN, index_sequence_type<Is...>, Ts...>::operator generic_key_value_pair<_UnusedN, Ts...>() const noexcept
	requires(sizeof...(Ts) == 2) {
		return generic_key_value_pair<_UnusedN, Ts...>{
