...
namespace sl::generic {
	template<
		traits::specialization_of<generic::lookup_table> R, 
		typename Arg, 
...
namespace sl::generic {
	...
	requires (
		...
		traits::same_container_as<R, generic::lookup_table, sl::size_constant_type<tuple_traits<XfrmSeq>::size>, int, placeholder_t>
	)
	...
	noexcept(
		...
		return impl::make_lookup_table_from_container<::sl::lookup_table<tuple_traits<XfrmSeq>::size, 
